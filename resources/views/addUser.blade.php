                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('addUser')}}">
                        ...
                        <label for="postalCode" class="col-md-4 col-form-label text-md-right">{{ __('Code Postal') }}</label>
                            ...
                            <div class="col-md-6">
                                <input id="postalCode" type="number" class="form-control @error('name') is-invalid @enderror" name="postalCode" required autocomplete="postalCode" autofocus>
                        ...
                        <label for="phoneNumber" class="col-md-4 col-form-label text-md-right">{{ __('Numéro de téléphone') }}</label>
                            ...
                            <div class="col-md-6">
                                <input id="phoneNumber" type="number" class="form-control @error('name') is-invalid @enderror" name="phoneNumber"  required autocomplete="phoneNumber" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="wage" type="number" class="form-control @error('wage') is-invalid @enderror" name="wage"   autocomplete="wage">
