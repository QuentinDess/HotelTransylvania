                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('updateRoom', $room->id)}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" value="{{$room->name}}" class="form-control @error('name') is-invalid @enderror" name="name"  required autocomplete="name" autofocus>
                        ...
                        <label for="doorNumber" class="col-md-4 col-form-label text-md-right">{{ __('Numéro de porte') }}</label>
                            ...
                            <div class="col-md-6">
                                <input id="doorNumber" type="number" value="{{$room->doorNumber}}"  class="form-control @error('name') is-invalid @enderror" name="doorNumber"  required autocomplete="doorNumber" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="number" value="{{$room->price}}" class="form-control @error('price') is-invalid @enderror" name="price" required autocomplete="price">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="avatar" type="text" value="{{$room->avatar}}" class="form-control @error('avatar') is-invalid @enderror" name="avatar"   autocomplete="avatar">
