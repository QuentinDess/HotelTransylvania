...
//route crd booking
Route::post('/createBooking','BookingController@createBooking')->name('createBooking');
Route::post('/deleteBooking/{id}','BookingController@deleteBooking')->name('deleteBooking');
//route shop
Route::get('/Shop','ItemController@showShop')->name('shop');
Route::post('/createBasket','BasketController@createBasket')->name('createBasket');
Route::post('/updateBasket/{id}','BasketController@updateBasket')->name('updateBasket');